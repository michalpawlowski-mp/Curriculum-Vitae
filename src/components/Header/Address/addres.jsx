...
const Address = () => {
  return (
    <address className="d-flex flex-column m-0 mt-1 align-items-center">
      <a
      ...
      >
        <img
          className="img-adr object-fit-cover"
          title="Mój email"
          src={Email}
          alt="mój mail"
        />
      ...
      <div className="d-flex d-md-block justify-content-evenly w-100">
        <div className="d-flex flex-column ">
          <a
            title="+48 728 117 024"
            href="tel:+48728117024"
            className="text-black text-decoration-none mt-1 align-middle fs-6"
          >
            <img
              className="img-adr object-fit-cover"
              title="Mój telefon"
          ...
          <a
            title="pawlowskimichal.pl"
            href="https://pawlowskimichal.pl/"
            target="_blank"
            className="d-flex justify-content-center align-items-center mt-1 text-decoration-none"
          >
            <img
              className="img-adr object-fit-cover me-1"
              title="Moja strona internetowa"
              src={Web}
              alt="Link do mojej strony internetowej"
            />

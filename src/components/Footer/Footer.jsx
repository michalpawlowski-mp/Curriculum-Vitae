const LegalAndInfo = () => {
  return (
    <footer className="m-0 w-100 d-flex flex-column mb-1">
      <p className="text-center mx-1 my-0">
        Wyrażam zgodę na przetwarzanie moich danych osobowych dla potrzeb niezbędnych do
        realizacji procesu rekrutacji zgodnie z obowiązującą ustawą o ochronie danych
        osobowych.
      </p>
      <a
        target="_blank"
